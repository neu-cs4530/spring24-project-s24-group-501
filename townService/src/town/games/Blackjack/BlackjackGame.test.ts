import { GAME_FULL_MESSAGE, GAME_NOT_IN_PROGRESS_MESSAGE, INVALID_BET_MESSAGE, PLAYER_ALREADY_IN_GAME_MESSAGE, PLAYER_NOT_IN_GAME_MESSAGE } from '../../../lib/InvalidParametersError';
...
describe('BlackjackGame', () => {
    ...
    describe('placeBet', () => {
       ...
       it('should throw an error if the player is not in the game', () => {
        expect(() => game.placeBet(createPlayerForTesting(), 20)).toThrowError(PLAYER_NOT_IN_GAME_MESSAGE);
       })
    ...
    describe('applyMove', () => {
        beforeEach(() => {
            game.state.hands = [
                {player : "1", active : true, ante : 10, hand : [
                    {type : "Clubs", value : 10, faceUp : true},
                    {type : "Clubs", value : "K", faceUp : true}]
                },
                {player : "2", active : true, ante : 10, hand : [
    ...
    describe('Overhandler', () => {
        beforeEach(() => {
            game.state.hands = [
                {player : "1", active : false, ante : 10, hand : [
                    {type : "Clubs", value : 10, faceUp : true},
                    {type : "Clubs", value : "A", faceUp : true}]
                },
                {player : "2", active : false, ante : 100, hand : [
                    {type : "Hearts", value : 7, faceUp : true},
                    {type : "Clubs", value : 6, faceUp : true},
                    {type : "Clubs", value : 3, faceUp : true}]
                },
                {player : "3", active : true, ante : 1000, hand : [
                    {type : "Hearts", value : 7, faceUp : true},
                    {type : "Clubs", value : 7, faceUp : true},]
                },
                {player : "4", active : false, ante : 1000, hand : [
