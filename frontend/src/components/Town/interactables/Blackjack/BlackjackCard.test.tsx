...
describe('BlackjackCard', () => {
  ...
  it('renders a face-up card correctly', () => {
    ...
    expect(suitIcon.innerHTML).toContain(hearts);
  });
  ...
  it('renders a face-down card correctly', () => {
    ...
    const { getByText, container } = render(<BlackjackCard {...faceDownCard} />);
    const cardValue = getByText('');
    expect(cardValue).toBeInTheDocument();
    const suitIcon = container.querySelector('svg');
    expect(suitIcon).not.toBeInTheDocument();
  });
  ...
  it('renders a card with a different suit correctly', () => {
    ...
    const suitIcon = container.querySelector('svg') as unknown as HTMLElement;
    expect(suitIcon).toBeInTheDocument();
    expect(suitIcon.innerHTML).toContain(diamonds);
  });
  ...
  it('renders a card with a different suit correctly', () => {
    ...
    const suitIcon = container.querySelector('svg') as unknown as HTMLElement;
    expect(suitIcon).toBeInTheDocument();
    expect(suitIcon.innerHTML).toContain(clubs);
  });
  ...
  it('renders a card with a different suit correctly', () => {
    ...
    const suitIcon = container.querySelector('svg') as unknown as HTMLElement;
    expect(suitIcon).toBeInTheDocument();
    expect(suitIcon.innerHTML).toContain(spades);
  });
